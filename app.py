...
# 1. Plotting the orbital motion with line-of-sight arrow
with col1:
    ...
    ax1.arrow(0, 0, 1.2, 0, head_width=0.1, head_length=0.1, fc='gray', ec='gray', label="Line of Sight")
    ax1.text(1.25, 0, 'Line of Sight', color='gray', verticalalignment='center')
