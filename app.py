...
# Set maximum velocity for maximum Doppler effect at maximum radial velocity positions
velocity = star_distance * 30  # Arbitrary velocity scaling based on distance from center of mass
