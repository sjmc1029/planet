...
with col2:
    ...
    wavelengths = np.linspace(655.5, 657.5, 1000)  # Adjusted range for greater contrast
    spectrum = np.exp(-((wavelengths - shifted_wavelength) ** 2) / 0.02)  # Narrow Gaussian for spectral line
